...
float EstimateHoverThru(void)
{
    ...
    Battery_InformationStructure.voltage_calculate = Battery_InformationStructure.voltage_factor * (Battery_InformationStructure.voltage_ad / 4096.0) * Battery_InformationStructure.voltage_ad_ref;  /* Calculate actual voltage */
