...
#define STATE_START_CONVERT_TEMP  0X01
#define STATE_CONVERTING_TEMP     0X02
#define STATE_START_CONVERT_PRES  0X03
#define STATE_CONVERTING_PRES     0X04

#define PRES_OFFSET_INIT_NUM      50

typedef int64_t s64;

extern bool pressure_offset_flag;
extern bool altitude_update_flag;
